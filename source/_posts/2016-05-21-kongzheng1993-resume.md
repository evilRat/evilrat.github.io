...
中移在线一体机项目是供移动营业厅一体机和pad等移动设备使用的web应用，使用springboot+freemarker+mysql。调用接口平台完成客户业务。

### 责任描述

项目搭建并开发，因为是给一体机和pad等终端提供页面，调用统一接口平台，所以使用了较为简单快速的springboot+freemarker，并在项目中负责开发了人证比对、实名制资料登记、补卡等业务流程。
