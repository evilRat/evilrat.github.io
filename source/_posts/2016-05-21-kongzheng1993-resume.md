...
数字化生产力中心-产品研发部门，负责长城汽车自营门店相关商业系统等研发工作。在多个重点项目中取得了显著成效，2025年度绩效A。

#### 商机任务系统重构--任务引擎设计与落地
在负责商机任务业务后，针对原有商机任务的实现进行了重构。设计并建设了事件驱动的任务引擎，实现了任务的自动化执行和管理。事件驱动的架构，实现了任务的解耦和异步处理，提高了系统的可扩展性和灵活性。完成20+种任务的重构与迁移，关键事件处理时长在50ms内，显著提升了业务处理效率，日均任务量50W。统一的定时任务框架，实现了周期性任务（意向跟进任务、21天电销跟进任务等）的生产上限和速率控制，减轻了系统负载，降本20%。

#### 直营零售系统
负责零售系统核心商机业务研发工作，承接相关需求及技术优化任务，完成系统迭代升级。
- 针对线索下发后商机的自动分配进行了重构优化，将线索下发与商机分配逻辑解耦，并使用责任链模式，将线索带入的零售门店、产品专家手机号、城市等因子解耦，根据优先级进行自动分配，代码复杂度降低50%，可读性提升80%。
- 重构了原有智能分配算法，根据偏差补偿的方式，提升智能分配准确率40%，提升分配效率30%


#### AI方向
**1）小智智能助手**
小智智能助手是嵌入到AioMP APP中的AI伙伴，支持语音唤醒与识别，能理解复杂意图并自动执行任务，为一线产品专家和零售店长提供便捷与智能服务。基于LangChain和Dify构建，通过MCP协议调用工具，并集成ASR技术实现语音交互。零售侧对其提供了商机、试驾、任务相关的MCP工具，为小智提供了数据支撑。


**2）AI线索排序**
通过修改商机任务的开始、截止时间，调整一线用户任务看板的任务数据排序，从而将AI模型判定出的高价值商机提升优先级，达到提升商机转化率的目的。在短时间内快速响应、设计、实现了任务系统推送创建任务通知，AI模型侧计算商机价值，通知业务系统修改任务时间的过程，并通过MQ实现同步转异步，保证了系统性能和稳定性。
...
- 了解OpenClaw、Hermes Agent、ClaudeCode、OpenCode等AI相关原理与使用
---
